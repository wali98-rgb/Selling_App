...
<body>
    ...
    <section class="hero">
        <div class="hero-title">
            <h1 class="hero-main-title">Buat Pembeli <span>Page</span></h1>
        ...
        <div class="content-motor">
            <form action="create-act.php" method="post">
                <div class="form-input">
                    <input type="text" name="nama_pembeli" id="" placeholder="Inputkan Nama Pembeli..." required autofocus>
                </div>
                <div class="form-input">
                    <input type="password" name="password" id="" placeholder="Inputkan Password Pembeli..." required>
                </div>
                <div class="form-input">
                    <textarea name="alamat" id="" cols="30" rows="10" placeholder="Inputkan Alamat Pembeli..." required></textarea>
                </div>
                ...
                <div class="form-input">
                    <input type="text" name="pekerjaan" id="" placeholder="Inputkan Pekerjaan Pembeli..." required>
                </div>
                <div class="form-submit">
                    <input type="submit" name="simpan" id="" value="Simpan" class="btn-plus">
