...
<body>
    ...
    <section class="hero">
        <div class="hero-title">
            <h1 class="hero-main-title">Pembeli <span>Page</span></h1>
            ...
            <table class="motor-table" cellpadding="10">
                ...
                <tbody>
                    <?php
                        ...
                        $data = mysqli_query($con, "select * from user where role='pembeli' order by nama_pembeli asc");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="update.php?id=<?php echo $d['id_pembeli']; ?>" class="btn-edit"><i class="bi bi-pencil"></i></a>
                            <a href="delete.php?id=<?php echo $d['id_pembeli']; ?>" class="btn-delete"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
