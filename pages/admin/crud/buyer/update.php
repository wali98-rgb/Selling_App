...
<head>
    ...
    <style>
        ...
        .content .content-motor form .form-input input, textarea {
            margin: .5rem 0;
            padding: 1rem;
            max-width: 76.5rem;
            width: 100%;
        ...
        .content .content-motor form .form-input-jk {
            display: flex;
        }
        
        .content .content-motor form .form-input-jk label {
            padding: 1rem 0;
            color: var(--text);
            font-size: 1.2rem;
        }
...
<body>
    ...
    <section class="hero">
        <div class="hero-title">
            <h1 class="hero-main-title">Edit Pembeli <span>Page</span></h1>
    ...
    <section class="content">
        <a href="index.php" class="btn-back">
            ...
            <span>Kembali ke Pembeli Page</span>
        </a>
        <div class="content-motor">
            <form action="update-act.php" method="post">
                <?php
                    ...
                    $id_pembeli = $_GET['id'];
                    $data = mysqli_query($con, "select * from user where id_pembeli='$id_pembeli'");

                    while ($d = mysqli_fetch_array($data)) {
                ?>
                <input type="hidden" name="id_pembeli" id="" value="<?php echo $d['id_pembeli']; ?>" required>
                <div class="form-input">
                    <input type="text" name="nama_pembeli" id="" placeholder="Inputkan Nama Pembeli..." value="<?php echo $d['nama_pembeli']; ?>" required autofocus>
                </div>
                <div class="form-input">
                    <input type="password" name="password" id="" placeholder="Inputkan Password Pembeli..." value="<?php echo $d['password']; ?>" required>
                </div>
                <div class="form-input">
                    <textarea name="alamat" id="" cols="30" rows="10" placeholder="Inputkan Alamat Pembeli..." required><?php echo $d['alamat']; ?></textarea>
                </div>
                <div class="form-input-jk">
                    <label for="">Jenis Kelamin : &nbsp;</label>
                    <input class="form-radio" type="radio" name="j_kelamin" id="laki_laki" value="Laki-laki" required><label for="laki_laki">&nbsp; Laki-laki &nbsp;</label>
                    <input class="form-radio" type="radio" name="j_kelamin" id="perempuan" value="Perempuan" required><label for="perempuan">&nbsp; Perempuan &nbsp;</label>
                </div>
                <div class="form-input">
                    <input type="text" name="pekerjaan" id="" placeholder="Inputkan Pekerjaan Pembeli..." value="<?php echo $d['pekerjaan']; ?>" required>
                </div>
                <div class="form-submit">
                    <input type="submit" name="ubah" id="" value="Ubah" class="btn-plus">
                    <input type="reset" name="reset" id="" value="Reset" class="btn-reset">
                </div>
                <?php } ?>
            </form>
        </div>
