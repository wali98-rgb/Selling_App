...
<body>
    ...
    <section class="hero">
        <div class="hero-title">
            <h1 class="hero-main-title">Buat Katalog <span>Page</span></h1>
        ...
        <div class="content-motor">
            <form action="create-act.php" method="post" enctype="multipart/form-data">
                <div class="form-input">
                    <input type="file" name="foto_motor" id="" placeholder="Inputlan Foto Motor..." required>
                </div>
                <div class="form-input">
                    <input type="text" name="merek_motor" id="" placeholder="Inputkan Merek Motor..." required autofocus>
                </div>
                <div class="form-input">
                    <input type="text" name="slug_motor" id="" placeholder="Inputkan Slug Motor..." required>
                </div>
                <div class="form-input">
                    <input type="number" name="stok_motor" id="" placeholder="Inputkan Jumlah Stok..." required>
                </div>
                <div class="form-input">
                    <input type="number" name="harga_motor" id="" placeholder="Inputkan Harga Motor..." required>
                </div>
