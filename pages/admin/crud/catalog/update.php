...
<body>
    ...
    <section class="hero">
        <div class="hero-title">
            <h1 class="hero-main-title">Edit Katalog <span>Page</span></h1>
    ...
    <section class="content">
        ...
        <div class="content-motor">
            <?php
                ...
                $data = mysqli_query($con, "select * from katalog where slug_motor='$slug_motor'");
            ...
            <form action="update-act.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-input">
                    <input type="file" name="foto_motor" id="" placeholder="Inputlan Foto Motor..." value="<?php echo $d['foto_motor']; ?>" required>
                </div>
                <div class="form-input">
                    <input type="text" name="merek_motor" id="" placeholder="Inputkan Merek Motor..." value="<?php echo $d['merek_motor']; ?>" required autofocus>
                </div>
                <div class="form-input">
                    <input type="text" name="slug_motor" id="" placeholder="Inputkan Slug Stok..." value="<?php echo $d['slug_motor']; ?>" required>
                </div>
                <div class="form-input">
                    <input type="number" name="stok_motor" id="" placeholder="Inputkan Jumlah Stok..." value="<?php echo $d['stok_motor']; ?>" required>
                </div>
                <div class="form-input">
                    <input type="number" name="harga_motor" id="" placeholder="Inputkan Harga Motor..." value="<?php echo $d['harga_motor']; ?>" required>
                </div>
                <div class="form-submit">
                    <input type="submit" name="ubah" id="" value="Ubah" class="btn-plus">
                    <input type="reset" name="reset" id="" value="Batal" class="btn-reset">
                </div>
            </form>
            <?php } ?>
        </div>
