...
<body>
    ...
    <div id="popup" class="popup">
        <div class="popup-content" id="popup-content">
            ...
            ?>
            <a href="katalog.php" onclick="close()" id="close" class="close"><i class="bi bi-x-circle"></i></a>
            <h1 class="popup-title">Yakin Beli?</h1>
            <div class="popup-desc">
                <div class="popup-img">
                    <img src="../admin/crud/catalog/foto_motor/<?php echo $dm['foto_motor']; ?>" alt="<?php echo $dm['merek_motor']; ?>">
                </div>
                <div class="popup-main">
                    <form action="buy_motor.php" method="POST">
                        <div>
                        ...
                        <div class="popup-btn">
                            <button type="submit" name="beli_motor" class="btn-beli">Yakin</button>
                            <a class="btn-no" href="katalog.php">Tidak</a>
                        </div>
                    </form>
                </div>
            </div>
